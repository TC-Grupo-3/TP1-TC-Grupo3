...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    #    self.dl_cursor_t.horizontalHeader().setSectionResizeMode(3, QtWidgets.QHeaderView.ResizeToContents)
        ...
        self.Xsubs = QTableWidgetItem('X2-X1')
        self.Ysubs = QTableWidgetItem('Y2-Y1')
        self.Xinv = QTableWidgetItem('1/(X2-X1)')
    ...
    def hideFunction(self):
        if(self.selected_dataline_data.alpha == 0):
            self.selected_dataline_data.alpha = 1
        else:
